					...
					<div>
						...
						<div class="mt-4 space-y-2 text-sm">
							...
							<div class="flex items-center space-x-2">
								<div
									class="h-4 w-4 rounded-sm border {passwordChecks.length
										? 'bg-green-500'
										: 'border-gray-300'}"
								></div>
								<span class={passwordChecks.length ? 'text-green-500' : 'text-gray-700'}
									>At least 8 characters</span
								>
							</div>
							<div class="flex items-center space-x-2">
								<div
									class="h-4 w-4 rounded-sm border {passwordChecks.uppercase
										? 'bg-green-500'
										: 'border-gray-300'}"
								></div>
								<span class={passwordChecks.uppercase ? 'text-green-500' : 'text-gray-700'}
									>One uppercase letter</span
								>
							</div>
							<div class="flex items-center space-x-2">
								<div
									class="h-4 w-4 rounded-sm border {passwordChecks.lowercase
										? 'bg-green-500'
										: 'border-gray-300'}"
								></div>
								<span class={passwordChecks.lowercase ? 'text-green-500' : 'text-gray-700'}
									>One lowercase letter</span
								>
							</div>
							<div class="flex items-center space-x-2">
								<div
									class="h-4 w-4 rounded-sm border {passwordChecks.number
										? 'bg-green-500'
										: 'border-gray-300'}"
								></div>
								<span class={passwordChecks.number ? 'text-green-500' : 'text-gray-700'}
									>One number</span
								>
							</div>
							<div class="flex items-center space-x-2">
								<div
									class="h-4 w-4 rounded-sm border {passwordChecks.special
										? 'bg-green-500'
										: 'border-gray-300'}"
								></div>
								<span class={passwordChecks.special ? 'text-green-500' : 'text-gray-700'}
