...
<div class="backgroundImage flex min-h-screen flex-col items-center justify-center">
	{#if statusState === 200}
	...
	<div class="w-full max-w-md rounded-lg bg-white p-8 shadow-lg">
		...
		<h2 class="text-maroon mb-6 text-center text-2xl font-bold">Admin Login</h2>
