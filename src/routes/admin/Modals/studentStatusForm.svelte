<script lang="ts">
	import { Label, Input, Select, Button, Fileupload, A, Modal } from 'flowbite-svelte';
	...
	<div class="p-8">
		...
		<form class="space-y-6">
			<div class="grid gap-6 md:grid-cols-4">
				<div>
					...
					<Input bind:value={firstname} readonly class="bg-gray-50" />
				</div>
				<div>
					<Label for="lastName">Last Name</Label>
					<Input bind:value={lastname} readonly class="bg-gray-50" />
				</div>
				<div>
					<Label for="middleName">Middle Name</Label>
					<Input bind:value={middleName} readonly class="bg-gray-50" />
				</div>
				<div>
					<Label for="email">Email</Label>
					<Input bind:value={email} readonly class="bg-gray-50" />
				</div>
			</div>
			...
			<div class="grid gap-6 md:grid-cols-4">
				...
				<div>
					...
					<Input id="address" bind:value={address} placeholder="Enter your address" />
				</div>
				<div>
					<Label for="residency">Residency</Label>
					<Input id="residency" bind:value={residency} placeholder="Enter your residency" />
				</div>
				<div>
					<Label for="contactNumber">Contact Number</Label>
					<Input id="contactNumber" bind:value={contactNumber} placeholder="Enter contact number" />
				</div>
			</div>
			...
			<div class="grid gap-6 md:grid-cols-2">
				<div>
					...
					<Fileupload placeholder={schoolId} />
				</div>
				<div>
					<div class="flex flex-row gap-5">
						{#if cor != ''}
		...
		<div class="flex flex-row justify-end gap-5">
			<form method="post" action="?/Accepted">
				...
				<Button type="submit" color="blue">Accept</Button>
			</form>
